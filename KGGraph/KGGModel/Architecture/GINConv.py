...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        edge_embeddings = self.edge_embedding0(edge_attr[:,0]) + self.edge_embedding1(edge_attr[:,1]) 
        # + self.edge_embedding2(edge_attr[:,2]) + self.edge_embedding3(edge_attr[:,3]) + self.edge_embedding4(edge_attr[:,4]) + self.edge_embedding5(edge_attr[:,5])
