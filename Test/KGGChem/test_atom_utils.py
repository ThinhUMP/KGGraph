...
from KGGraph.KGGChem.atom_utils import (
    get_mol, get_smiles, sanitize, get_atomic_number, atomic_num_features, set_atommap, atom_equal, 
    copy_atom, get_atom_types,
)
...
class TestChemUtils(unittest.TestCase):
    ...
    def test_atom_equal(self):
        ...
        self.assertTrue(atom_equal(self.mol.GetAtomWithIdx(0), self.mol.GetAtomWithIdx(0)))  # Carbon with itself
        self.assertFalse(atom_equal(self.mol.GetAtomWithIdx(0), self.mol.GetAtomWithIdx(1)))  # Carbon with Oxygen
