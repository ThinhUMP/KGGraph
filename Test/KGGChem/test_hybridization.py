...
class TestHybridizationFeaturize(unittest.TestCase):
    ...
    def test_num_bond_hybridization(self):
        ...
        self.assertEqual(HybridizationFeaturize.num_bond_hybridization(self.atom_ethane), 4)  # SP3 hybridization
        self.assertEqual(HybridizationFeaturize.num_bond_hybridization(self.atom_ethene), 3)  # SP2 hybridization
        self.assertEqual(HybridizationFeaturize.num_bond_hybridization(self.atom_ethyne), 2)  # SP hybridization
