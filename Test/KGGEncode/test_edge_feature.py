...
class TestEdgeFeature(unittest.TestCase):
    ...
    def test_edge_feature(self):
        ...
        self.assertTrue(
            18 > edge_attr.size(0)
        )  # 18 is the number of edges before masking
        self.assertTrue(
            18 > edge_index.size(1)
        )  # 18 is the number of edges before masking
        self.assertTrue(
            0.5 in edge_attr_node[:, 3]
        )  # 0.5 is the number of pi for aromatic ring
        ...
        self.assertTrue(
            57 == edge_attr.size(0)
        )  # 57 is the number of edges before masking
        self.assertTrue(
            57 == edge_index.size(1)
        )  # 57 is the number of edges before masking
        self.assertTrue(
            0.5 in edge_attr_node[:, 3]
        )  # 0.5 is the number of pi for aromatic ring
        ...
        self.assertTrue(
            70 > edge_attr.size(0)
        )  # 70 is the number of edges before masking
        self.assertTrue(
            70 > edge_index.size(1)
        )  # 70 is the number of edges before masking
        self.assertTrue(
            0.5 in edge_attr_node[:, 3]
        )  # 0.5 is the number of pi for aromatic ring
