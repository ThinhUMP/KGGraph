...
class MoleculeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print('smiles',smiles)
        mol_graph = MolGraph(smiles, self.decompose_type)  #motif
        # mol_tree.recover()
        # mol_tree.assemble()
        return mol_graph
...
class MolGraph(object):
    ...
    def __init__(self, smiles, decompose_type):
        ...
        self.edge_attr_nosuper, self.edge_index, self.edge_attr = edge_feature(self.mol, decompose_type=decompose_type)
        # atom_features_list = []
        # for atom in self.mol.GetAtoms():
        #     atom_feature = [allowable_features['possible_atomic_num_list'].index(
        #         atom.GetAtomicNum())] + [allowable_features[
