...
def main():
    ...
    parser.add_argument('--lr_feat', type=float, default=0.0005,
    ...
    parser.add_argument('--input_model_file', type=str, default = 'saved_model_masknode80/pretrain.pth', help='filename to read the model (if there is any)')
