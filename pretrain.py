...
def main():
    ...
    parser.add_argument(
        "--output_model_file",
        type=str,
        default="./saved_model_onehot/pretrain.pth",
    ...
    if not os.path.isdir("./saved_model_onehot"):
        os.mkdir("./saved_model_onehot")
    if "pretrain.pth" in os.listdir("saved_model_onehot"):
