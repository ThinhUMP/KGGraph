...
def main():
    ...
    parser.add_argument(
        "--output_model_file",
        type=str,
        default="./saved_model_KGGwoBondtype/pretrain.pth",
    ...
    if not os.path.isdir("./saved_model_KGGwoBondtype"):
        os.mkdir("./saved_model_KGGwoBondtype")
    if "pretrain.pth" in os.listdir("saved_model_KGGwoBondtype"):
