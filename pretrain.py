...
def main():
    ...
    if not os.path.isdir("./saved_model_mlp_ce_charger_test"):
        os.mkdir("./saved_model_mlp_ce_charger_test")
    if "pretrain.pth" in os.listdir("saved_model_mlp_ce_charger_test"):
