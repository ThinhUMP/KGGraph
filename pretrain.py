...
def main():
    ...
    parser.add_argument(
        "--output_model_file",
        type=str,
        default="./saved_model_mlp_ce_0.6dropout/pretrain.pth",
    ...
    if not os.path.isdir("./saved_model_mlp_ce_0.6dropout"):
        os.mkdir("./saved_model_mlp_ce_0.6dropout")
    if "pretrain.pth" in os.listdir("saved_model_mlp_ce_0.6dropout"):
